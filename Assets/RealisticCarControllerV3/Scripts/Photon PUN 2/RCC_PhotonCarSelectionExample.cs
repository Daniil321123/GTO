...
/// </summary>
[AddComponentMenu("BoneCracker Games/Realistic Car Controller/Network/Photon/RCC Photon Car Selection Example")]
public class RCC_PhotonCarSelectionExample : MonoBehaviour {
	...
	private RCC_CarControllerV3 selectedVehicle;
...
//		RCC_SceneManager.Instance.RegisterPlayer (_spawnedVehicles [selectedIndex], false, false);
	...
	public void SelectVehicle(){
		...
		selectedVehicle = PhotonNetwork.Instantiate("Photon Vehicles/" +RCC_DemoVehicles.Instance.vehicles[selectedIndex].gameObject.name, spawnPosition.position, spawnPosition.rotation, 0).GetComponent<RCC_CarControllerV3>();
